                  ...
                  <body>
                      <div style='z-index: 3;'>
                        <div id='header'>
                         ...
                         <br/><br/><br/><br/><br/>
                             <form id='frmC' method='post' action='adminCliente.php'>
                                 <table class='tablaC' border='0'>
                                     <tr>
                                         <td colspan='6' id='tdHeader'>GESTIONAR CLIENTES</td>
                                     </tr>    
                                     <tr>
                                         ...
                                         <td colspan='4'>
                                         <input class='btnR' type='submit' name='nuevoCliente' value='Registar nuevo cliente'/>
                                         </td>
                                     </tr>
                                 </table>
                             </form>";
                             ...
                             if(isset($_POST['buscar']) && $_POST['buscarCod']){
                                 ...
                                 if($fila){
                                  ...
                                  $demanda=$fila['demanda'];
                                     echo"<br/>
                                         <form id='frmC' name='frmC' method='POST' action='adminCliente.php' onsubmit='return validarFormCliente(this)'>
                                            <table class='tablaC' border='0'>
                                                    <tr>
                                                     ...
                                                     <tr>
                                                      ...
                                                      <tr>
                                                       ...
                                                       <tr>
                                                            <td colspan='2'><input type='submit' class='btnM' name='modificarCliente' value='Modificar'/>
                             ...
                             if(isset($_POST['nuevoCliente'])){
                                 echo"<br/>
                                         <form id='frmC' name='frmC' method='post' onsubmit='return validarFormCliente(this)'>
                                            <table class='tablaC' border='0'>
                                                    <tr>
                                                     ...
                                                     <tr>
                                                      ...
                                                      <tr>
                                                       ...
                                                       <tr>
                                                            <td colspan='6'><input type='submit' class='btnM' name='insertarCliente' value='Guardar'/>
                                                       </tr>
                                                </table>
                                          </form>
                                         ";
